            ...
            "characters": [
                {
                    ...
                    "gender": getattr(char, "gender", None) or "",
                    "age": getattr(char, "age", None) or "",
                    "appearance": getattr(char, "appearance", None) or "",
                    "personality": getattr(char, "personality", None) or "",
                    "background": getattr(char, "background", None) or "",
                    "core_motivation": getattr(char, "core_motivation", None) or "",
                    "inner_lack": getattr(char, "inner_lack", None) or "",
        ...
        try:
            ...
            for char_data in data.get("characters", []):
                ...
                character = Character(
                    ...
                    inner_lack=char_data.get("inner_lack") or "",
